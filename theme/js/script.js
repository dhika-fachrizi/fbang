...
(function ($) {
	...
	function init_menu() {
		...
		// var c_h = $(".menu-container").height() + $(".main-nav").height()
		// $(".table-center-text").css({
		// 	"padding-top": c_h + "px"
		// });
		...
		$(window).on("scroll", function () {
			if ($(window).scrollTop() > 10) {
				...
				$(".menu-container").addClass("hide-menu-category");

			} else {

				$(".menu-container").removeClass("hide-menu-category");
	...
	const $dropdownToggle = $(".dropdown-togglea");
