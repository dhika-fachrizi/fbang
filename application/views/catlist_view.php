        ...
        <main class="cd-main-content">
                    ...
                    <div class="row">
                        <?php if (!empty($category)) : ?>
                            <div class="col-sm-12 pt-30 pb-30 pl-0" style="font-size:12px;">
                                Home/<?php echo $category['type_name'] ?>/<a href=""><u><?php echo $category['category_name'] ?></u> </a>
                            </div>
                        <?php else : ?>
                            <div class="col-sm-12 pt-30 pb-30 pl-0" style="font-size:12px;">
            ...
            <?php if (!empty($thumbnail)) : ?>
                <section name="top-ras">
                    <div class="container">
                        <div class="row pb-20">
                            <div class="col-sm-7 news-b-image m-0" style="background-image: url('<?php echo base_url() . 'assets/images/' . $thumbnail->detail_category_image; ?>') ;height:430px;">
                            </div>
                            <div class="col-sm-5">
                                <div class="col-sm-12">
                                ...
                                <div class="col-sm-12  text-thema-split-7" style="height:330px;">
                                    <div class="text-theme-1" style="margin-top: 0px;font-size:40px;font-weight:bold; line-height: normal;">
                    ...
                    <div class=" container pt-30">
                        <div class="row mb-30">
                            <div class="col-sm-3 pl-0">
                                            ...
                                            <div id="popover_content_wrapper" style="display:none;">
                                                ...
                                                <div id="popover-form" hidden>
                                                    <div style="width:600px;">
                                                        <div class="col-sm-12 pb-10" style="border: 5px solid #DDDDDD;" class="">
                                                            <div class="pt-10 pb-0 pl-20 row">
                                                                <div class="pr-10 colot-theme-1"><i class="fas fa-search"></i></div>
                                                                <div>
                                                                    <input type="text" id="search-city" style="border:0px;" class="nofocus-input" onkeydown="cityFind(this)">
                                                                </div>
                                                            </div>
                                                                                ...
                                                                                <ul class="cty-ul">
                                                                                    <?php foreach ($value2 as $value3) : ?>
                                                                                        <li class="cty-li colot-theme-1">
                                                                                            <div class="form-check">
                                                                                                <input class="form-check-input" type="checkbox" value="<?php echo $value3['city_id'] ?>" name="city[]" onchange="cityCheck(this)">
                                                            ...
                                                            <div class="row  pr-20 d-flex justify-content-end">
                                                                <div><button class="btn-city" class="btn btn-sm">Reset</button></div>
                                                                <div><button class="btn-city" style="background-color:#F79D46;" onclick="submitMoreCity()" class="btn btn-sm">Submit</button>
                                                                </div>
                                ...
                                <div class="col-sm-12 pl-0 news-b-image m-0 " style="background-image: url('') ; background-color:#F4F4F4; height: 238px;" hidden>
                                </div>
                            </div>
                            <div class="col-sm-9">
                                <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="row d-flex justify-content-end">
                                                    <div class="pr-10 pt-0">
                                                        <div class="" style="width:0px;" id="c-search"> <input type="text" id="c-search-input" value="<?php echo $get_search ?>" name="search" class="form-control form-control-sm" style="border:0px; outline:0px; border-bottom:1px black solid; border-radius:0px ;padding:0px;">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div>
                                                        <select class="form-control form-control-sm" name="short" style="border:0px; outline:0px; border-bottom:1px black solid; border-radius:0px" onchange="submit()">
                                                            <option value="" disable>Urutkan Berdasarkan</option>
                                                            <option value="DESC" <?php echo $get_short == "DESC" ? "selected" : ""; ?>>
                                                                Postingan Terbaru</option>
                                                            <option value="ASC" <?php echo $get_short == "ASC" ? "selected" : ""; ?>>
                                            ...
                                            <?php if (count($catlist) > 0) : ?>
                                                <?php foreach ($catlist as $item) : ?>
                                                    <div class="col-md-4 pb-20">
                                                        <div class="row pl-10">
                                                            <div class="col-sm-12">
                                                                <div class="row" style="border:1px #DDDDDD solid;border-radius:3px;">
                                                                    <div class="col-sm-12 popular-b-image m-0 pl-10" style="background-image: url('<?php echo base_url() . 'assets/images/' . $item->post_image; ?>') ; height:266px;">
                                                                    </div>
                                                                    <div class="col-sm-12 mt-10 pl-10 text-thema-split-2" style="height:45px;">
                                                                        <div class="text-theme-1" style="margin-top:0px;font-size:18px;font-weight:bold;letter-spacing: 0px; line-height: normal;">
                                                                            <a href="<?php echo base_url() . $dynamic_detail_link . $item->post_slug; ?>">
                                                                    ...
                                                                    <div class="col-sm-12 mtc-5 ">
                                                                        <div class="row pl-10">
                                                                            <div class="col-sm-1 p-0">
                                                                                <i class="fas fa-home" style="font-size:12px;color:red;">
                                                                                </i>

                                                                            </div>

                                                                            <div class="col-sm-11 colot-theme-1 pl-0" style="font-size:12px;">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <div class="row pl-10">
                                                                            <div class="col-sm-1 p-0">
                                                                                <i class="fas fas fa-map-marker" style="font-size:12px;color:red;">
                                                                                </i>
                                                                            </div>
                                                                            <div class="col-sm-11 colot-theme-1 pl-0" style="font-size:12px; text-transform: capitalize;">
                                                                                <?php echo strtolower($item->city_name); ?>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-12 pl-0 mt-10" style="height:55px;">
                                                                        <div class="col-sm-12 pl-10">
                                                                            <?php $count = ""; ?>
                                                                            <?php $split_tag = explode(",", $item->post_tags);
                                                                            foreach ($split_tag as $tag) : ?>
                                                                                <div class="float-left" style="padding:0px 5px 5px 0px">
                                                                                    <div class=" " style="background-color:#F0F0F0; color:#919191; padding:2px 5px; border-radius:5px; font-size:10px;">
                                                                                        <?php echo $tag; ?>
                                    ...
                                    <div class="col-md-12 d-flex justify-content-center pb-60 pt-30">
                                        <div class="row">
                                            <?php if (count($catlist) > 0) : ?>
                                                ...
                                                <?php endif; ?>
                                                <input type="number" id="perpage" name="perpage" <?php if ($get_perpage >= 0) : ?> value="<?php echo $get_perpage; ?>" <?php endif; ?> style="display: none">
                                            <?php endif; ?>
                                        </div>
                                    </div>
