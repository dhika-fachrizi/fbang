                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="row cpl-0">
                                ...
                                <div class="col-sm-12 pl-0 text-theme-2" style="font-size:40px;font-weight: bold;word-spacing:-1px;">
                                    <?= $detail['post_title'] ?>
                                </div>
                            </div>
                                ...
                                <div class="row pr-10">
                                    ...
                                    <div class="col-12 pl-0 text-thema-split-2" style="height:50px;">
                                        <div class="text-theme-1" style="margin-top:0px;font-size:15px;font-weight:bold;">
                                            <a href="<?php echo base_url() . 'news/detail/' . $item['post_slug']; ?>"><?= $item['post_title'] ?></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
