                                    ...
                                    <div class="showSearch">
                                        ...
                                        <div class="row pb-20 cpl-0 pr-10">
                                            ...
                                            <div class="col-md-12" style="padding-right: 0px;padding-left: 0px;">
                                                <div class="col-12 colot-theme-1"
                                                    style="font-size:15px;padding-right: 0px;padding-left: 0px;"><span><?php $date = date_create($item['post_date']);
echo date_format($date, "d M Y");?>
                                                        | <?=$item['post_views']?>
                                                        Min Read</span></div>
                                                <div class="col-12  text-thema-split-2"
                                                ...
                                                <div class="col-12  text-thema-split-4"
                                                    style="padding-right: 0px;padding-left: 0px;" text-theme-1>
                                                    <div class="colot-theme-1" style="font-size:15px;">
                                                        <?=$item['post_description']?>
                                                    </div>
                                                ...
                                                <div class="col-12 mt-10"
                                                    style="font-size:15px;padding-right: 0px;padding-left: 0px;">
                                                    <a class="a-link-c" href="<?php if ($item['post_type_id'] == 1) {
    echo base_url() . 'news/detail/' . $item['post_slug'];
} else if ($item['post_type_id'] == 2) {
    echo base_url() . 'catlist/detail/' . $item['post_slug'];
