                    ...
                    <div class="row mb-30">
                        ...
                        <div class="col-sm-9">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="row">
                                        <div class="col-sm-8 t-5-b">Menampilkan 1 - 12 dari total 200 Resaturants</div>
                                        <div class="col-sm-4">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="row"
                                                        ...
                                                        <div class="col-sm-12 popular-b-image m-0 pl-10"
                                                            style="background-image: url('<?php echo base_url() . 'assets/images/sushi-on-brown-wooden-board-2098085.png'; ?>') ; height:170px;">
                                                        </div>
                                                        ...
                                                        <div class="col-sm-12 mtc-5 ">
                                                            <div class="row pl-10">
                                                                ...
                                                                <div class="col-sm-11 colot-theme-1"
