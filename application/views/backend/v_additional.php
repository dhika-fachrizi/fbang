                ...
                <ul class="menu accordion-menu">
                    ...
                    <li class="droplink active open"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li class="active"><a href="<?php echo site_url('backend/additional'); ?>">Additional</a></li>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                        <a href="javascript:void(0);" class="btn btn-xs btn-edit" onclick="edt(<?php echo $row->additional_id; ?>,'<?php echo $row->additional_name; ?>',<?php echo $row->category_id; ?>)" data-id="<?php echo $row->additional_id; ?>" data-additional="<?php echo $row->additional_name; ?>"><span class="fas fa-edit"></span></a>
                                                        <a href="javascript:void(0);" class="btn btn-xs btn-delete" onclick="del(<?php echo $row->additional_id; ?>)" data-id="<?php echo $row->additional_id; ?>"><span class="fa fa-trash"></span></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="text" name="additional" class="form-control" placeholder="additional Name" required>
                        </div>
                    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="text" name="additional2" class="form-control" placeholder="additional Name" required>
                        </div>
