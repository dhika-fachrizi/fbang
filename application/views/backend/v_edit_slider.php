...
if ($query->num_rows() > 0):
    ...
    ?>
        ...
        <div class="page-inner">
            ...
            <div id="main-wrapper">
                <div class="row">
                    <form action="<?php echo base_url() . 'backend/slider/edit' ?>" method="post"
                                        ...
                                        <div class="panel-body" style="height:100%">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" name="filefoto" class="dropify" data-height="400"
                                                    data-default-file="<?php echo base_url() . 'assets/images/' . $b['slider_image']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="panel panel-white">
                                        <div class="panel-body">
                                            <div class="form-group">
                                                <label>Title</label>
                                                <textarea name="title" cols="6" rows="12" class="form-control"
                                                    placeholder="Title"><?php echo $b['slider_title'] ?></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label>Description</label>
                                                <input type="text" name="description" class="form-control title"
                                                    value="<?php echo $b['slider_desc'] ?>" placeholder="Description"
                                                    required>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="link" class="form-control title"
                                                            value="<?php echo $b['slider_link'] ?>" placeholder="Link"
                                                            required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" min="1" name="order"
                                                            value="<?php echo $b['slider_order'] ?>"
                                                            class="form-control title" placeholder="Order" required>
                                                    </div>
                                                </div>
