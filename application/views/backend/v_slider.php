                ...
                <ul class="menu accordion-menu">
                    ...
                    <li class="droplink"><a href="#" class="waves-effect waves-button"><span
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="<?php echo site_url('backend/detail_category'); ?>">Category
                                    Detail</a></li>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-white">
                            <div class="panel-body">
                                <a href="<?php echo site_url('backend/slider/add_new'); ?>"
                                    class="btn btn-success m-b-sm">Add New Slider</a>
...
foreach ($data->result() as $row):
    ...
    ?>
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    <a
                                                        href="<?php echo site_url('backend/slider/get_edit/' . $row->slider_id); ?>"><i
                                                            class="fas fa-edit"></i></a>


                                                    <a href="javascript:void(0);" class="btn btn-xs btn-delete"
                                                        onclick="del(<?php echo $row->slider_id; ?>)"
                                                        data-id="<?php echo $row->slider_id; ?>"><span
    ...
    <!--DELETE RECORD MODAL-->
    <form action="<?php echo site_url('backend/slider/delete'); ?>" method="post">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="alert alert-info">
                            Anda yakin mau menghapus slider ini?
                        </div>
                    </div>
