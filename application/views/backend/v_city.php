...
<body class="page-header-fixed compact-menu pace-done page-sidebar-fixed">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                        <a href="javascript:void(0);" class="btn btn-xs btn-edit" onclick="edt(<?php echo $row->city_id; ?>,'<?php echo $row->city_name; ?>')" data-id="<?php echo $row->city_id; ?>" data-city="<?php echo $row->city_name; ?>"><span class="fas fa-edit"></span></a>
                                                        <a href="javascript:void(0);" onclick="del(<?php echo $row->city_id; ?>)" class="btn btn-xs btn-delete" data-id="<?php echo $row->city_id; ?>"><span class="fa fa-trash"></span></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
    ...
    <!--ADD RECORD MODAL-->
    <form action="<?php echo site_url('backend/city/save'); ?>" method="post">
    ...
    <!--EDIT RECORD MODAL-->
    <form action="<?php echo site_url('backend/city/edit'); ?>" method="post">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="text" name="city2" class="form-control" placeholder="city Name" required>
                        </div>
    ...
    <!--DELETE RECORD MODAL-->
    <form action="<?php echo site_url('backend/city/delete'); ?>" method="post">
