                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                        <a href="javascript:void(0);" class="btn btn-xs btn-edit" onclick="edt(<?php echo $row->category_id; ?>,'<?php echo $row->category_name; ?>',<?php echo $row->type_id; ?>)" data-id="<?php echo $row->category_id; ?>" data-category="<?php echo $row->category_name; ?>" data-typeid="<?php echo $row->type_id; ?>" data-typename="<?php echo $row->type_name; ?>"><span class="fas fa-edit"></span></a>
                                                        <a href="javascript:void(0);" class="btn btn-xs btn-delete" onclick="del(<?php echo $row->category_id; ?>)" data-id="<?php echo $row->category_id; ?>"><span class="fa fa-trash"></span></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
