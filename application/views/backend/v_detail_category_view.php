                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                        <?php if (!isset($row->detail_category_id)) : ?>
                                                            <a href="<?php echo site_url('backend/detail_category/add_new/' . $row->category_id); ?>"><i class="fas fa-plus"></i></a>
                                                        <?php else : ?>
                                                            <a href="<?php echo site_url('backend/detail_category/get_edit/' . $row->category_id); ?>"><i class="fas fa-edit"></i></a>
                                                        <?php endif; ?>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
