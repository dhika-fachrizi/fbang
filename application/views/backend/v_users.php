...
if ($query->num_rows() > 0):
    ...
    ?>
                ...
                <ul class="menu accordion-menu">
                    ...
                    <li class="active"><a href="<?php echo site_url('backend/users'); ?>"
...
?>
                                            ...
                                            <td style="vertical-align: middle;"><a
                                                    href="<?php echo base_url() . 'backend/users/lock/' . $row->user_id; ?>"
                                                    class="btn"><span class="icon-lock-open" title="Unlock"></span></a>
                                            </td>
                                            <?php else: ?>
                                            <td style="vertical-align: middle;"><a
                                                    href="<?php echo base_url() . 'backend/users/unlock/' . $row->user_id; ?>"
                                                    class="btn"><span class="icon-lock" title="Locked"></span></a></td>
                                            <?php endif;?>
                                            <td style="vertical-align: middle;">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                        <li><a href="javascript:void(0);" data-toggle="modal"
                                                                data-target="#ModalEdit<?php echo $row->user_id; ?>"><span
                                                                    class="icon-pencil"></span> Edit</a></li>
                                                        <li><a href="javascript:void(0);" class="delete"
                                                                data-userid="<?php echo $row->user_id; ?>"><span
    ...
    <!-- Modal -->
    <form id="add-row-form" action="<?php echo base_url() . 'backend/users/insert' ?>" method="post"
...
?>
    <!-- Modal -->
    <form id="add-row-form" action="<?php echo base_url() . 'backend/users/update' ?>" method="post"
        enctype="multipart/form-data">
        <div class="modal fade" id="ModalEdit<?php echo $row->user_id; ?>" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="file" name="filefoto" class="dropify" data-height="220"
                                        data-default-file="<?php echo base_url() . 'assets/images/' . $row->user_photo; ?>">
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    <input type="text" name="nama" value="<?php echo $row->user_name; ?>"
    ...
    <!-- Modal hapus-->
    <form id="add-row-form" action="<?php echo base_url() . 'backend/users/delete' ?>" method="post"
        enctype="multipart/form-data">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="hidden" id="txt_kode" name="kode" class="form-control" placeholder="Name"
                                required>
                        </div>
