                                                ...
                                                <?php foreach ($social->result() as $row) : ?>
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" detail_name=<?php echo json_encode($row); ?> class="form-control title social_post" ` placeholder="<?php echo $row->social_name; ?> link">
                                                        </div>
                                                    </div>
                                                <?php endforeach; ?>
                                            </div>
                                                ...
                                                <?php foreach ($availability->result() as $row) : ?>
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" detail_name=<?php echo json_encode($row, 0); ?> class="form-control title availability_post" placeholder="<?php echo $row->availability_name; ?> Link">
                                                        </div>
                                                    </div>
                                                <?php endforeach; ?>
                                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label>Phone</label>
                                        <input type="Phone" name="catlist_phone" class="form-control" placeholder="" required>
                                    </div>
