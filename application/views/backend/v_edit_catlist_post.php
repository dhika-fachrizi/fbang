                                                ...
                                                <?php foreach ($social->result() as $row) : ?>
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" detail_name=<?php echo json_encode($row); ?> <?php foreach ($b_social as $soc) : ?> <?php if ($soc->social_id == $row->social_id) : ?> value="<?php echo $soc->social_value ?>" <?php endif; ?> <?php endforeach; ?> class="form-control title social_post" placeholder="<?php echo $row->social_name; ?> link">
                                                        </div>
                                                    </div>
                                                <?php endforeach; ?>
                                            </div>
                                                ...
                                                <?php foreach ($availability->result() as $row) : ?>
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" detail_name=<?php echo json_encode($row, 0); ?> <?php foreach ($b_availability as $soc) : ?> <?php if ($soc->availability_id == $row->availability_id) : ?> value="<?php echo $soc->availability_value ?>" <?php endif; ?> <?php endforeach; ?> class="form-control title availability_post" placeholder="<?php echo $row->availability_name; ?> Link">
                                                        </div>
                                                    </div>
                                                <?php endforeach; ?>
                                            </div>
