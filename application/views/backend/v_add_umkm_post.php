...
if ($query->num_rows() > 0):
    ...
    ?>
        ...
        <div class="page-inner">
            ...
            <div id="main-wrapper">
                <div class="row">
                    <form action="<?php echo base_url() . 'backend/post/publish_umkm' ?>" method="post"
                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="Restaurant" name="umkm_name" class="form-control" placeholder=""
                                            required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label>Address</label>
                                        <input type="Address" name="umkm_address" class="form-control" placeholder=""
                                            required>
                                    </div>
