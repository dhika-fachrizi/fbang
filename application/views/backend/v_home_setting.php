    ...
    <main class="page-content content-wrap">
        <div class="navbar">
            <div class="navbar-inner">
                ...
                <div class="logo-box">
                    <a href="<?php echo site_url('backend/dashboard'); ?>" class="logo-text"><span></span></a>
                </div><!-- Logo Box -->
...
<li class=""><a href="<?php echo site_url('backend/post/add_catlist_new'); ?>">Add New
        ...
        <div class="page-inner">
            ...
            <div id="main-wrapper">
                <div class="row">
                    <form class="form-horizontal" action="<?php echo base_url() . 'backend/home_setting/update' ?>"
                            ...
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="caption1" class="form-control" id="input1"
                                                value="<?php echo $caption_1; ?>" placeholder="Site Name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="caption2" class="form-control" id="input1"
                                                value="<?php echo $caption_2; ?>" placeholder="Site Title">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <img src="<?php echo base_url() . 'theme/images/' . $image_heading; ?>"
                                                width="560" class="thumbnail">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="input1" class="col-sm-2 control-label">Background
                                            Testimonial</label>
                                        <div class="col-sm-10">
                                            <input type="file" name="img_testimonial" class="form-control" id="input1">
                                            <p class="help-block">Background Testimonial harus beresolusi 925 x 617
                                                Pixels.</p>
                                            <img src="<?php echo base_url() . 'theme/images/' . $image_testimonial; ?>"
                                                width="560" class="thumbnail">
                                        </div>
                                    </div>
