...
error_reporting(0);
$b = $data->row_array();
$b_social = json_decode($b['detail_umkm_social']);
$b_availability = json_decode($b['detail_umkm_availability']);
$b_gmaps = json_decode($b['detail_umkm_gmaps']);
?>
<!DOCTYPE html>
<html>
...
if ($query->num_rows() > 0):
    ...
    ?>
        ...
        <div class="page-inner">
            ...
            <div id="main-wrapper">
                <div class="row">
                    <form action="<?php echo base_url() . 'backend/post/edit_umkm' ?>" method="post"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="Restaurant" name="umkm_name" class="form-control"
                                            value="<?php echo $b['detail_umkm_name'] ?>" placeholder="" required>
                                    </div>


                                    <div class="form-group">
                                        <label>Address</label>
                                        <input type="Address" name="umkm_address" class="form-control"
                                            value="<?php echo $b['detail_umkm_address'] ?>" placeholder="" required>
                                    </div>


                                    <div class="form-group">
                                        <label>Phone</label>
                                        <input type="Phone" name="umkm_phone" class="form-control" placeholder=""
                                            value="<?php echo $b['detail_umkm_phone'] ?>" required>
                                    </div>
                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    <div class="form-group">
                                        <label>Gmaps</label>
                                        <input type="maps" name="umkm_maps" class="form-control" id="autocomplete"
                                            placeholder="">
                                        <input type="hidden" name="maps" value='<?=$b['detail_umkm_gmaps']?>'
                                            id="gmaps">
                                    </div>
                                    <div class="form-group">
