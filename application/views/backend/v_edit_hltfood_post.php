...
error_reporting(0);
$b = $data->row_array();
$b_social = json_decode($b['detail_hltfood_social']);
$b_availability = json_decode($b['detail_hltfood_availability']);
$b_gmaps = json_decode($b['detail_hltfood_gmaps']);
?>
<!DOCTYPE html>
<html>
...
<body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
    ...
    <main class="page-content content-wrap">
        ...
        <div class="page-inner">
            ...
            <div id="main-wrapper">
                <div class="row">
                    <form action="<?php echo base_url() . 'backend/post/edit_hltfood' ?>" method="post" enctype="multipart/form-data">
                        <div class="col-md-8">
                            <div class="row">
                                <div class="col-md-12">
                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="Restaurant" name="hltfood_name" class="form-control" value="<?php echo $b['detail_hltfood_name'] ?>" placeholder="" required>
                                    </div>


                                    <div class="form-group">
                                        <label>Address</label>
                                        <input type="Address" name="hltfood_address" class="form-control" value="<?php echo $b['detail_hltfood_address'] ?>" placeholder="" required>
                                    </div>


                                    <div class="form-group">
                                        <label>Phone</label>
                                        <input type="Phone" name="hltfood_phone" class="form-control" placeholder="" value="<?php echo $b['detail_hltfood_phone'] ?>" required>
                                    </div>
