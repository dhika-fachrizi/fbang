...
<li><a href="<?php echo site_url('backend/slider'); ?>">Slider</a></li>
        ...
        <div class="page-inner">
            ...
            <div id="main-wrapper">
                <div class="row">
                    <form action="<?php echo base_url() . 'backend/post/edit_hltfood' ?>" method="post"
                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="Restaurant" name="hltfood_name" class="form-control"
                                            value="<?php echo $b['detail_hltfood_name'] ?>" placeholder="" required>
                                    </div>


                                    <div class="form-group">
                                        <label>Address</label>
                                        <input type="Address" name="hltfood_address" class="form-control"
                                            value="<?php echo $b['detail_hltfood_address'] ?>" placeholder="" required>
                                    </div>


                                    <div class="form-group">
                                        <label>Phone</label>
                                        <input type="Phone" name="hltfood_phone" class="form-control" placeholder=""
                                            value="<?php echo $b['detail_hltfood_phone'] ?>" required>
                                    </div>
