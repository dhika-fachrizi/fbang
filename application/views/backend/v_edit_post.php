                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="Restaurant" name="news_name" class="form-control" value="<?php echo $b['detail_news_name'] ?>" placeholder="" required>
                                    </div>


                                    <div class="form-group">
                                        <label>Address</label>
                                        <input type="Address" name="news_address" class="form-control" value="<?php echo $b['detail_news_address'] ?>" placeholder="" required>
                                    </div>


                                    <div class="form-group">
                                        <label>Phone</label>
                                        <input type="Phone" name="news_phone" class="form-control" placeholder="" value="<?php echo $b['detail_news_phone'] ?>" required>
                                    </div>
