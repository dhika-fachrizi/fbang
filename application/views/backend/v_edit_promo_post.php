                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="promo_start" class="form-control" placeholder="" value="<?php echo date('Y-m-d', time($b['detail_promo_start'])); ?>" required>

                                    </div>

                                    <div class="form-group">
                                        <label>Promo End</label>
                                        <input type="date" name="promo_end" class="form-control" placeholder="" value="<?php echo date('Y-m-d', time($b['detail_promo_end'])); ?>" required>
                                    </div>
