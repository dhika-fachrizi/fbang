                                                ...
                                                <?php foreach ($availability->result() as $row) : ?>
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" detail_name='<?php echo json_encode($row, 0); ?>' class="form-control availability_post" placeholder="<?php echo $row->availability_name; ?> Link">
                                                        </div>
                                                    </div>
                                                <?php endforeach; ?>
                                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label>City</label>
                                        <select class="form-control" style="text-transform: capitalize;" name="city" required>
                                            <option value="">-Select Option-</option>
                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="Restaurant" name="news_name" class="form-control" placeholder="" required>
                                    </div>


                                    <div class="form-group">
                                        <label>Address</label>
                                        <input type="Address" name="news_address" class="form-control" placeholder="" required>
                                    </div>


                                    <div class="form-group">
                                        <label>Phone</label>
                                        <input type="Phone" name="news_phone" class="form-control" placeholder="" required>
                                    </div>
