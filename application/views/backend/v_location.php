                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                        <a href="javascript:void(0);" class="btn btn-xs btn-edit" onclick="edt(<?php echo $row->location_id; ?>,'<?php echo $row->location_name; ?>')" data-id="<?php echo $row->location_id; ?>" data-location="<?php echo $row->location_name; ?>"><span class="fas fa-edit"></span></a>
