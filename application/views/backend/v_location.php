...
<body class="page-header-fixed compact-menu pace-done page-sidebar-fixed">
                ...
                <ul class="menu accordion-menu">
                    ...
                    <li class="droplink active open"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li class="active"><a href="<?php echo site_url('backend/location'); ?>">Location</a></li>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                        <a href="javascript:void(0);" class="btn btn-xs btn-edit" onclick="edt(<?php echo $row->location_id; ?>,'<?php echo $row->location_name; ?>',<?php echo $row->category_id; ?>)" data-id="<?php echo $row->location_id; ?>" data-location="<?php echo $row->location_name; ?>"><span class="fas fa-edit"></span></a>
                                                        <a href="javascript:void(0);" class="btn btn-xs btn-delete" onclick="del(<?php echo $row->location_id; ?>)" data-id="<?php echo $row->location_id; ?>"><span class="fa fa-trash"></span></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
    ...
    <!--ADD RECORD MODAL-->
    <form action="<?php echo site_url('backend/location/save'); ?>" method="post">
    ...
    <!--EDIT RECORD MODAL-->
    <form action="<?php echo site_url('backend/location/edit'); ?>" method="post">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="text" name="location2" class="form-control" placeholder="location Name" required>
                        </div>
    ...
    <!--DELETE RECORD MODAL-->
    <form action="<?php echo site_url('backend/location/delete'); ?>" method="post">
