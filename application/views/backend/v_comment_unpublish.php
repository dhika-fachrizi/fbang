...
<html>
    <head>
        ...
        <link href="<?php echo base_url() . 'assets/plugins/fontawesome/css/font-awesome.css' ?>" rel="stylesheet" type="text/css"/><link href="<?php echo base_url() . 'assets/plugins/fontawesome/css/all.css' ?>" rel="stylesheet" type="text/css"/>
...
<li class=""><a href="<?php echo site_url('backend/post/add_catlist_new'); ?>">Add New
                        ...
                        <li class="active"><a href="<?php echo site_url('backend/comment'); ?>" class="waves-effect waves-button"><span class="menu-icon icon-bubbles"></span><p>Comments</p></a></li>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <?php foreach ($data->result() as $row): ?>
                                            <div class="search-item">
                                                ...
                                                <a href="javascript:void(0);" class="search-link"><b><?php echo $row->comment_name ?></b>, <?php echo $row->comment_date; ?></a> <?php if ($row->comment_status == '0') {echo "<span class='label label-danger'>Unpublish</span>";} else {}?>
